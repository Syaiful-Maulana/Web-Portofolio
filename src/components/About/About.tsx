            ...
            <div className='flex justify-center'>
              ...
              >
                ...
                <div className='group relative aspect-square h-fit w-36 rounded-full bg-base-100 md:w-5/6'>
                  <div>
                    <Image
                      src='/syaiful_avatar.png'
                      width={500}
                      height={500}
                      className='absolute transition-all duration-500 ease-in-out group-hover:translate-y-4 group-hover:translate-x-0.5 group-hover:scale-125 md:group-hover:translate-x-2 md:group-hover:translate-y-6'
                      alt='Foto gweh'
                    />
                  </div>
                </div>
