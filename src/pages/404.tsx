    ...
    <>
      ...
      <div className='min-w-screen grid min-h-screen place-items-center'>
        <motion.div
          ...
          className='container -mt-24 flex grid max-w-md grid-cols-1 items-center gap-4 px-4 md:-mt-0 md:max-w-3xl md:grid-cols-2 lg:max-w-5xl'
        >
          ...
          <div className='space-y-4 px-4'>
            ...
            <Link href='/'>
              <a className='btn btn-outline flex w-fit items-center space-x-2'>
                <svg
